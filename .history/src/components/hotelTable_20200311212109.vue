    ...
    <div class="form">
        ...
        <el-form :model="form" label-width="80px" :rules="formRules" ref="form">
            ...
            <el-form-item label="电话" prop="phone">
                <el-input v-model="form.phone" auto-complete="off" style="width:25%"></el-input>
            </el-form-item>

            <el-form-item label="详细信息" prop="info">
                <el-input type="textarea" v-model="form.info" autosize maxlength="50" show-word-limit placeholder="餐馆详细介绍">
                </el-input>
            </el-form-item>

            <el-form-item label="营业时间" prop="time">
                <el-input  placeholder="例如: 8:00 -- 21:00" v-model="form.time">
                </el-input>
            </el-form-item>
