    ...
    <div class="form">
        ...
        <el-form :model="form" label-width="80px" :rules="formRules" ref="form">
            <el-form-item label="餐馆名" prop="name">
                <el-input v-model="form.dishes" auto-complete="off" style="width:20%"></el-input>
            </el-form-item>

            <el-form-item label="电话" prop="price">
                <el-input v-model="form.price" auto-complete="off" style="width:25%"></el-input>
            </el-form-item>

            <el-form-item label="详细信息" prop="price">
                <el-input type="textarea" autosize maxlength="50" show-word-limit placeholder="餐馆详细介绍" v-model="textarea">
                </el-input>
            </el-form-item>
